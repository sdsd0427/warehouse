		...
		<div style="display: flex; justify-content: space-between; padding: 10px 0; align-items: center">
			...
			<div class="work-search input-group input-group-sm" style="padding-top: 10px; width: 40%">
					...
					<span class="input-group-append">
						<button type="button" class="btn bg-navy" onclick="list_go('depWorkList.do', 1, 0)">
				...
				<div class="card-body" style="display: flex; justify-content: space-between;">
					<div class="col-md-2">
						<div class="small-box bg-danger">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 0)">
					...
					<div class="col-md-2">
						<div class="small-box bg-info">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 1)">
								<b style="border: 1px soild white; border-radius: 50%">
										${noneCheckCnt.get('1')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-success">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 2)">
								<b style="border: 1px soild white; border-radius: 50%">
										${noneCheckCnt.get('2')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-primary">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 3)">
								<b style="border: 1px soild white; border-radius: 50%">
										${noneCheckCnt.get('3')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-warning">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 4)">
								<b style="border: 1px soild white; border-radius: 50%">
										${noneCheckCnt.get('4')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-secondary">
							<div class="inner" onclick="list_go('depWorkList.do', 1, 5)">
								<b style="border: 1px soild white; border-radius: 50%">
										${noneCheckCnt.get('5')}
									</b>
				...
				<div class="card-header bg-navy p-0 pt-1 border-bottom-0">
					<ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
						...
						<li class="nav-item">
							...
							aria-selected="true" href="javascript:list_go('depWorkList.do',1,3)" data-status="3">협업요청
						...
						<li class="nav-item">
							...
							aria-selected="true" href="javascript:list_go('depWorkList.do',1,4)" data-status="4">대리요청
						...
						<li class="nav-item">
							...
							aria-selected="true" href="javascript:list_go('depWorkList.do',1,5)" data-status="5">전체
