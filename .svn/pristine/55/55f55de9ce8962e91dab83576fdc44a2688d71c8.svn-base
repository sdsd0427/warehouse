			...
			<div class="container-fluid">
				<div class="row md-2">
					...
					<div style="display: inline; margin-left: 10px; margin-top: 10px;">
						<span  class="text-muted"  style="padding-right: 535px;">전자결재 > 기안문서함</span>
					</div>
				</div>
			</div>
		</section>
		...
		<div class="row " style="justify-content: space-between;margin-bottom: -9px;">
			<div class="card col-12 card-outline card-navy" style="padding: 0">
				...
				<div class="card-body" style="display: flex; justify-content: space-between;">
					<div class="col-md-2">
						<div class="small-box bg-danger" onclick="list_go('draftList.do',1,1);">
							<div class="inner">
					...
					<div class="col-md-2">
						<div class="small-box bg-info" onclick="list_go('draftList.do',1,2);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('2')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-success" onclick="list_go('draftList.do',1,3);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('3')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-primary" onclick="list_go('draftList.do',1,4);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('4')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-warning" onclick="list_go('draftList.do',1,5);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('5')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-secondary" onclick="list_go('draftList.do',1,0);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('0')}
								</b>
				...
				<div style="display: flex; justify-content: space-between; float: right;">
					<div class="input-group input-group-sm row approve-search" style="display: flex; margin-top: 20px;">
						...
						<span class="input-group-append">
							<button class="btn btn-dark" type="button" data-card-widget="search" onclick="list_go('draftList.do',1,0);">
						...
						<tbody>
							...
							<c:forEach items="${draftList }" var="draft">
								<tr style="font-weight: ${draft.scheck eq 1 ? '' : 'bold'};" onclick="goDetail('approval/detailGo.do?signNo=${draft.signNo }','${menu.mcode }')">
									...
									<td class="field-content" data-field="제목" style="text-align: left; max-width: 130px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${draft.title}</td>
									...
									<td class="field-content" data-field="최종결재자" style="text-align: left;">${draft.lastSigner }</td>
...
<%-- 					<%@ include file="/WEB-INF/views/common/pagination.jsp" %> --%>
					...
					<ul class="pagination justify-content-center m-0">
						...
						<li class="page-item">
							<a class="page-link" href="javascript:list_go('draftList.do',${pageMaker.cri.page+1 gt pageMaker.realEndPage ? pageMaker.realEndPage : pageMaker.cri.page+1},${dataMap.state })">
