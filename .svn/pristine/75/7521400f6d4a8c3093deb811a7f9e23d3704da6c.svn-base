...
<body>
	<div class="wrapper">
		...
		<div class="card" style="padding: 20px 40px 20px 20px;">
			<form id="proceedForm" method="post" action="proceedRegist.do" enctype="multipart/form-data">
				...
				<table class="table">
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" class="form-control" placeholder="회의록 제목을 입력해주세요." name="title">
						</td>
					</tr>
					<tr>
						<td colspan="2">
