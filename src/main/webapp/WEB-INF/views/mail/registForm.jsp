	...
	<section class="content" style="margin-top: -50px;">
		<div class="container-fluid">
			<div class="card card-navy card-outline">
				<div class ="card-tools" style="float: left; padding: 7px 0; border-bottom: 1px solid lightgray;">
					<div class="aa" style="display: flex; font-size: medium;">
						...
						<div class="float-right" style="margin-left: 553px;">
							...
							<button type="button" class="btn btn-sm btn-outline-dark" onclick="javascript:history.back();" style="width: 83px; height: 38px;">
						...
						<div class="form-group row">
							...
							<div class="input-group input-group-sm col-md-10">
								<span class="input-group-append">
									<button type="button" class="btn btn-sm bg-navy" data-toggle="modal" data-target="#myModal" style="width: 70px; height: 31px; border-radius: 0.2rem;">주소록</button>
								</span>
...
<!-- 						</div> -->
						...
						<div class="card card-light card-outline">
							<div class="card-header">
								...
								<i class="fas fa-paperclip"></i>&nbsp;&nbsp;첨부파일</h5>&nbsp;&nbsp;&nbsp;
		...
		<div class="modal-dialog modal-mg" style="width: 350px">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h5 class="modal-title">수신자 선택</h5>
			...
			<div style="position: relative;">
				<div style="display: flex; align-items: center">
					<div style="display: flex; align-items: center;">
						...
						<span style="font-size:12px; padding-right:5px; align-self:flex-end">{{ppsname}}</span>
					</div>
