							...
							<tbody id="tableBot">
								<tr>
									...
									<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<span data-select-option="true" id="loginName">${allSign.name }</span>
								...
								<tr>
									...
									<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<span data-select-option="true" id="deptName">${allSign.dname }</span>
								...
								<tr>
									...
									<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<span data-select-option="true" id="signDOCNO">${allSign.signNo }</span>
									</td>
								</tr>
							</tbody>
						</table>
								...
								<span class="sign_member">
									<span class="sign_rank_wrap">
										<span id="ppsloginname"class="sign_rank">
											<input type="hidden" name="ppsname" value="">${allSign.ppsname }
										</span>
									</span>
			...
			<tbody>
				<tr>
					...
					<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;" colspan="3">
						<input type="text" style="width: 100%; height: 100%;border: 0;" name="title"  placeholder="제목을 작성하세요" value="${allSign.title }">
					</td>
				</tr>
				<tr>
					<td colspan='5'>
						<textarea class="form-control" name="signContent" id="signContent" rows="5" cols="" placeholder="" >${allSign.signContent }</textarea>
					</td>
				</tr>
			</tbody>
		</table>
