				...
				<tbody>
					...
					<tr>
						...
						<td
							...
							data-editable="false" name="vacStart" data-value="" value="" >&nbsp;~&nbsp;
							...
							name="vacEnd" data-value="" value="" onchange="DateEnd()"></td>
					</tr>
					<tr>
						<td
						...
						<td
							...
							style="line-height: normal; font-family: malgun gothic, dotum, arial, tahoma; font-size: 9pt; margin-top: 0px; margin-bottom: 0px;"><b>신청연차
								...
								value="1" readonly="readonly" ></span><b
...
function DateEnd(){
	...
	document.getElementById("GapDate").innerHTML=dateGap + "일";
	document.getElementById("GapDate").text=일;
