...
<c:set var="viewerList" value="${dataMap.viewerList }" />
		...
		<div class="container-fluid">
			<div class="row md-2">
				...
				<div style="display: inline; margin-left: 10px; margin-top: 10px;">
					<span  class="text-muted"  style="padding-right: 535px;">전자결재 > 참조문서함</span>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="row" style="justify-content: space-between; margin-bottom: -9px;">
			<div class="card col-12 card-outline card-navy" style="padding: 0">
				...
				<div class="card-body" style="display: flex; justify-content: space-between;">
					<div class="col-md-2">
						<div class="small-box bg-danger" onclick="list_go('viewerList.do',1,1);">
							<div class="inner">
					...
					<div class="col-md-2">
						<div class="small-box bg-info" onclick="list_go('viewerList.do',1,2);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('2')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-success" onclick="list_go('viewerList.do',1,3);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('3')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-primary" onclick="list_go('viewerList.do',1,4);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('4')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-warning" onclick="list_go('viewerList.do',1,5);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('5')}
								</b>
					...
					<div class="col-md-2">
						<div class="small-box bg-secondary" onclick="list_go('viewerList.do',1,0);">
							<div class="inner">
								<b style="border: 1px soild white; border-radius: 50%">
									${noneCheckCnt.get('0')}
								</b>
			...
			<div class="col-7">
				<div style="display: flex; justify-content: space-between; float: right;">
					<div class="input-group input-group-sm row approve-search" style="display: flex; margin-top: 20px;">
						<select class="form-control col-3" name="signForm" id="signForm" onchange="list_go('viewerList.do',1,0);" style="width: 30%;">
						...
						<span class="input-group-append">
							<button class="btn btn-dark" type="button" data-card-widget="search" onclick="list_go('viewerList.do.do',1,0);">
			...
			<div class="card col-12" style="margin-top: 15px; padding: 0;">
				<div class="card-header bg-navy p-0 pt-1 border-bottom-0">
					<ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 1 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,1);">대기</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 2 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,2);">보류</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 3 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,3);">진행</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 4 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,4);">반려</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 5 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,5);">완료</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ${dataMap.state eq 0 ? 'active' : '' }" id="custom-tabs-three-home-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="list_go('viewerList.do',1,0);">전체</a>
						</li>
					</ul>
				</div>
						...
						<tbody>
							...
							<c:forEach items="${viewerList }" var="viewer">
								<tr style="font-weight:${viewer.scheck eq 1 ? '' : 'bold'};" onclick="goDetail('approval/detailGo.do?signNo=${viewer.signNo }','${menu.mcode }')">
									...
									<td class="field-content" data-field="결재양식">${viewer.formText}</td>
									<td class="field-content" data-field="긴급">
										<c:if test="${viewer.emergency eq '1'}">
											<span class="material-symbols-outlined">e911_emergency </span>
										</c:if>
									</td>
									<td class="field-content" data-field="제목" style="text-align: left; max-width: 130px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${viewer.title}</td>
									<td class="field-content" data-field="첨부">
										<c:if test="${!empty viewer.attachList }">
											<i class="fas fa-paperclip"></i>
										</c:if>
									</td>
									<td class="field-content" data-field="기안자">${viewer.name}</td>
									<td class="field-content" data-field="기안부서">${viewer.dname}</td>
									<td class="field-content" data-field="최종결재자" style="text-align: left;">${viewer.lastSigner }</td>
									<td class="field-content" data-field="문서번호">${viewer.signNo}</td>
									<td class="field-content" data-field="결재상태">
										<c:if test="${viewer.state eq '1'}">
											<span class="badge bg-danger">대기</span>
										</c:if>
										<c:if test="${viewer.state eq '2'}">
											<span class="badge bg-info">보류</span>
										</c:if>
										<c:if test="${viewer.state eq '3'}">
											<span class="badge bg-success">진행</span>
										</c:if>
										<c:if test="${viewer.state eq '4'}">
											<span class="badge bg-primary">반려</span>
										</c:if>
										<c:if test="${viewer.state eq '5'}">
											<span class="badge bg-warning">완료</span>
										</c:if>
									</td>
									<td class="field-content" data-field="완료일">
										<fmt:formatDate value="${viewer.edate}" pattern="yyyy-MM-dd"/>
									</td>
								</tr>
							</c:forEach>
						</tbody>
...
<%-- 					<%@ include file="/WEB-INF/views/common/pagination.jsp" %> --%>
					...
					<ul class="pagination justify-content-center m-0">
						<li class="page-item">
							<a class="page-link" href="javascript:list_go('viewerList.do',1,${dataMap.state })">
								<i class="fas fa-angle-double-left"></i>
							</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="javascript:list_go('viewerList.do',${pageMaker.cri.page - 1 lt 0 ? 1 : pageMaker.cri.page - 1 },${dataMap.state })">
								<i class="fas fa-angle-left"></i>
							</a>
						</li>
						<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="page">
							<li class="page-item ${page eq pageMaker.cri.page ? 'active' : ''}">
								<a class="page-link" href="javascript:list_go('viewerList.do',${page },${dataMap.state })">
								${page }
								</a>
							</li>
						</c:forEach>
						<li class="page-item">
							<a class="page-link" href="javascript:list_go('viewerList.do',${pageMaker.cri.page+1 gt pageMaker.realEndPage ? pageMaker.realEndPage : pageMaker.cri.page+1},${dataMap.state })">
								<i class="fas fa-angle-right"></i>
							</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="javascript:list_go('viewerList.do',${pageMaker.realEndPage },${dataMap.state })">
